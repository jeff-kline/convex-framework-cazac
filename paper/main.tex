...
Bj\"orck's Legendre-symbol-phase construction, proved here only on a
symmetry-invariant subspace (full regularity is available in the
literature \cite{Benoist24}, not proved in this paper); the same specific
